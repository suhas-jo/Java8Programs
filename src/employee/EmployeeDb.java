...
public class EmployeeDb {
    ...
    public static List<Employee> getEmployees() {
        ...
        Employee employee2 = new Employee(102,22, "Bob", "HR",25000, address2);
        Address address7 = new Address("5 Main St", "Springfield", "IL", "62708");
        Employee employee7 = new Employee(107,35, "George", "DEV-OPS",25000, address7);

        Address address8 = new Address("4 Main St", "Springfield", "IL", "62709");
        Employee employee8 = new Employee(108,30, "Hannah", "Engineering",25000, address8);

        Address address9 = new Address("5 Main St", "Springfield", "IL", "62708");
        Employee employee9 = new Employee(109,31, "Ivan", "DEV-OPS",25000, address9);

        Address address3 = new Address("43 Main St", "Springfield", "IL", "62703");
        Employee employee3 = new Employee(103,24, "Charlie", "QA",25000, address3);

        Address address4 = new Address("9 Main St", "Springfield", "IL", "62705");
        Employee employee4 = new Employee(104,28, "Diana", "Engineering",25000, address4);

        Address address5 = new Address("8 Main St", "Springfield", "IL", "62706");
        Employee employee5 = new Employee(105,56, "Edward", "HR",25000, address5);

        Address address6 = new Address("7 Main St", "Springfield", "IL", "62707");
        Employee employee6 = new Employee(106,34, "Fiona", "QA",25000, address6);
